...
## 2. What is ARN in AWS?

## 3. Name the three basic types of Cloud Service Models?

## 4. Explain the difference between High Availability and Disaster Recovery.

## 5. Explain a few cloud security best practices.

## 6. How to manage cloud infrastructure as a DevOps Engg in AWS?

## 7. What is the main difference between Terraform and AWS CloudFormation?

## 8. Explain how would you solve a production issue related to a CI/CD pipeline?

## 9. What are _Availability Zones_ and _Regions_?

## 10. How will you achieve high-availability for your application hosted on EC2 instance?

## 11. As per a best practice, how would you allow external users to access your private resources (present in private subnet)?

## 12. How Public subnets are different from Private subnets?

## 13. How will you achieve HA for EC2 Instance hosted application?

## 14. Explain how will you troubleshoot a connectivity issue if a web user in trying to connect to your EC2 Instance (linux) and getting below error:
